...
ดำเนินการคำสั่งจากสตริงที่ไม่รู้ว่าเชื่อถือได้หรือไม่อย่าหาทำ = exec
ปัดตัวเลข = round
...
def ปัดให้เป็นทศนิยม๕หลัก(ก: จำนวนจุดลอยตัว) -> จำนวนจุดลอยตัว:
    return ปัดตัวเลข(ก, จำนวนเต็ม(ඞ("๕")))
...
def main():
    ...
    พิมพ์สู่เอสทีดีเอาท์("Mosteller =", ปัดให้เป็นทศนิยม๕หลัก(
        สูตรคำนวณอะไรไม่รู้ผมเกลียดชีวะ.Mosteller(น้ำหนักรับเข้า, ส่วนสูงนำเข้า)))
    พิมพ์สู่เอสทีดีเอาท์("Du Bois =", ปัดให้เป็นทศนิยม๕หลัก(
        สูตรคำนวณอะไรไม่รู้ผมเกลียดชีวะ.DuBois(น้ำหนักรับเข้า, ส่วนสูงนำเข้า)))
    พิมพ์สู่เอสทีดีเอาท์("Fujimoto =", ปัดให้เป็นทศนิยม๕หลัก(
        สูตรคำนวณอะไรไม่รู้ผมเกลียดชีวะ.ふじもと(น้ำหนักรับเข้า, ส่วนสูงนำเข้า)))


ดำเนินการคำสั่งจากสตริงที่ไม่รู้ว่าเชื่อถือได้หรือไม่อย่าหาทำ(
    ข้อมูลนําเข้าจากเอสทีดีอิน())
